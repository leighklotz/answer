...
lx /home/klotz/wip/answer/bin/{answer,ask,help,bx,gx,lx,functions,help-commit,logging,lx,tools,unfence}.sh \
   /home/klotz/wip/answer/bin/commands/{hx-bootstrap,hx,PS1,model,models,what,why,cat}.sh \
   /home/klotz/wip/answer/bin/commands/{stats,cache,context,describe,provenance}.sh \
   ...
   /home/klotz/wip/toolex/{toolex,tooling,__init__,bash_tools,file_tools,git_tools}.py \
  ...
  ask 'This is you: ~/wip/answer and ~/wip/toolex/. ' \
      'Feel free to explore. '\
      'Goal: Read the python and bash code and give an assessment of the harness.' |
  count-tokens
  #answer -t > ~/"wip/answer/.hallux/self-explore-list-$$-${mdl}"
